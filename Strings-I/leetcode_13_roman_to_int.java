// Striver's SDE Sheet - String 1 - Leetcode Q13 - Java
...
public class leetcode_13_roman_to_int {
    public int romanToInt(String s) {
        ...
        int num = n.get(s.charAt(s.length()-1));
        
        for (int i = s.length()-2; i >=0; i--) {
            if (n.get(s.charAt(i+1)) > n.get(s.charAt(i))) {
                num -= n.get(s.charAt(i));
            } else {
                num += n.get(s.charAt(i));
            }
        }
